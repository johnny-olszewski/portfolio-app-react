export const Constants = {
  EXPERIENCE_DATA: [
    ...
    },
    {
      ...
      description:
        "Founding engineer architecting and leading development of Next.js and React Native applications with Neo4j and Django. Establish engineering workflows, CI/CD pipelines, and drive technical architecture decisions.",
      bullets: [],
